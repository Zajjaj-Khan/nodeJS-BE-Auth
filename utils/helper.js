...
export const sendEmail = (email,uniqueString)=>{
  ...
  <body style="font-family: 'Arial', sans-serif; margin: 0; padding: 0; background-color: #f4f7fa;">
    <table style="width: 100%; border-spacing: 0; padding: 0;">
      <tr>
        <td style="width: 100%; background-color: #f4f7fa; padding: 40px 0;">
          <div style="width: 600px; margin: 0 auto; background-color: #ffffff; padding: 30px; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);">
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <div style="font-size: 30px; font-weight: bold; color: #fff; background-color: #16a085; padding: 20px 30px; border-radius: 5px; margin: 20px 0; display: inline-block;">${uniqueString}</div>
              <p>This OTP is valid for the next 15 minutes. If you didn't request this, please ignore this email.</p>
              <a href="#" style="display: inline-block; background-color: #16a085; color: white; padding: 12px 30px; text-decoration: none; font-size: 16px; border-radius: 5px; margin-top: 20px;">Verify Your Email</a>
            </div>
            <div style="text-align: center; font-size: 12px; color: #7f8c8d; margin-top: 40px;">
              <p>Need help? <a href="#" style="color: #16a085; text-decoration: none;">Contact support</a></p>
